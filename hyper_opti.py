...
space = {
         ...
         'gnn_scale':hp.quniform('gat_scale', low=0.2, high=0.8, q=0.1),
         'dropout_fpn':hp.quniform('dropout', low=0.0, high=0.6, q=0.05),
         'dropout_gnn':hp.quniform('dropout_gat', low=0.0, high=0.6, q=0.05)
}
